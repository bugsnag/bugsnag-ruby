Feature: Rails handled and thrown error
...
Scenario Outline: Thrown handled NameError
  ...
  When I navigate to the route "/handled_thrown" on port "6128<rails_version>"
  ...
  And the event "metaData.request.url" ends with "/handled_thrown"
