Feature: Rails handled but unthrown error
...
Scenario Outline: Unhandled RuntimeError
  ...
  When I navigate to the route "/handled_unthrown" on port "6128<rails_version>"
  ...
  And the event "metaData.request.url" ends with "/handled_unthrown"
